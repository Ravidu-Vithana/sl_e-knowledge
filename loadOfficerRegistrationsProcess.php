...
//SELECTING ANY INVITATIONS SENT BY THE PARTICULAR ACADEMIC OFFICER
$sent_rs = Database::search("SELECT * FROM `sent` WHERE `inviter_type` = '3' AND `inviter_id` = '" . $_SESSION["officer"]["academic_officer_id"] . "'");
$sent_num = $sent_rs->num_rows;

if ($sent_num > 0) {
    //IF ANY INVITATIONS ARE AVAILABLE
...
?>
    ...
    //IF NO INVITATIONS ARE AVAILABLE
    ?>

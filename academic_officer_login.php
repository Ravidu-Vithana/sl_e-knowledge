...
<body class="bac">
        ...
        <div class="ui row">
            <div class="ui grid">
                <div class="ui fourteen wide column centered">
                    ...
                    <h1 class="ui header centered acTitle">Academic Officer Login</h1>
        ...
        <div class="ui row">
            <div class="ui centered grid">
                <div class="ui two column row">
                    <div class="eight wide computer and tablet only column ac_imageDiv"></div>
                    <div class="eight wide computer eight wide tablet sixteen wide mobile column">
                        <div class="ui row">
                            ...
                            if (isset($_COOKIE["ofu"])) {
                                $uname = $_COOKIE["ofu"];
                            }

                            if (isset($_COOKIE["ofp"])) {
                                $password = $_COOKIE["ofp"];
                            }
                        ...
                        <div class="ui row">
                            <div class="ui checkbox rememberMeDiv">
                                <input type="checkbox" id="rememberMe" <?php if (isset($_COOKIE["acp"])) {
                                                                        ?> checked <?php
                                                                                } ?>>
                        ...
                        <div class="ui row signInBtnDiv">
                            <button class="ui orange fluid button" onclick="signIn('3');">
                                Sign In
                            </button>
                        </div>
                        <div class="ui row">
                            <div>
                                <a class="forgotPasswordac" href="forgotPassword.php">Forgot Password?</a>
                            </div>
                            <div>
    ...
    <div class="ui modal" id="verification_modal">
        ...
        <div class="actions">
            ...
            <div class="ui positive right labeled icon button" onclick="Verification('3');">
                Verify!

...
if(isset($_GET["subject"]) && isset($_GET["grade"]) && isset($_GET["teacher"]) && isset($_GET["student"]) && isset($_GET["title"])){
    //IF THE DATE ARE RECERIVED PROPERLY
                ...
                <div class="ui two column stackable grid">
                    ...
                    <div class="ui centered six wide column grid file_item_action">
                        <div class="ui celled horizontal list">
                            <div class="item">
                                <button class="ui positive basic button" onclick="releaseMarks('<?php echo ($mark_data['mark_id']); ?>')">Release Marks</button>
                            </div>
                        </div>
                    </div>
                </div>
